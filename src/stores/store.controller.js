...
export class StoresController {
    ...
    createStoreInfo = async (req, res, next) => {
        try {
            ...
            const storeInfo = await this.storesService.createStoreInfo(aduserId, storeName, storeAddress, storeContact, storeContent, storeCategory);
            // 한바퀴 돌아서 클라이언트에게 반환
    ...
    updateStoreInfo = async (req, res, next) => {
        try {
            ...
            await this.storesService.updateStoreInfo(storeId, aduserId, storeName, storeAddress, storeContact, storeContent, storeCategory);
    ...
    deleteStoreInfo = async (req, res, next) => {
        try {
            ...
            const deleteStore = await this.storesService.deleteStoreInfo(storeId, aduserId, password, hashedPassword);
