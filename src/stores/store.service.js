...
export class StoresService {
  ...
  readystatusup = async (orderId, storeId, orderStatus) => {
    ...
    const updatedOrder = await this.storesRepository.readystatusup(
      orderId,
      storeId,
      orderStatus
    );
  ...
  ingstatusup = async (orderId, storeId, orderStatus) => {
    ...
    const updatedOrder = await this.storesRepository.ingstatusup(
      orderId,
      storeId,
      orderStatus
    );
  ...
  completestatusup = async (orderId, storeId, orderStatus) => {
    ...
    const decrementdPoint = await this.pointsRepository.storedecrementPoint(
      storeId,
      totalPrice,
      history
    );
    const updatedOrder = await this.storesRepository.completestatusup(
      orderId,
      storeId,
      orderStatus
    );
  ...
  deleteOrder = async (orderId, storeId) => {
    ...
    const incrementdPoint = this.pointsRepository.userdecrementPoint(
      user,
      cancelPrice,
      Pasthistory
    );
    const deletedOrder = await this.ordersRepository.deleteOrder(
      orderId,
      storeId
    );
  ...
  getStorebyAdId = async (aduserId) => {
    const store = await this.storesRepository.getStore(aduserId);
